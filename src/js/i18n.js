...
const I18N = {
  zh: {
    ...
    uploadHint: '拖放、粘贴或点击即可上传（单文件最大 {size}）',
    ...
    uploadWaiting: '等待中...',
    uploading: '正在上传...',
    uploadingProgress: '{percent}% · {loaded}/{total} · {speed}/秒',
    uploadPausing: '正在暂停 · {percent}% · {loaded}/{total} · {speed}/秒',
    uploadPaused: '已暂停 · {percent}% · {loaded}/{total}',
    pauseUpload: '暂停',
    resumeUpload: '继续',
    cancelUpload: '取消',
    uploadCanceling: '正在取消并清理...',
    uploadCanceled: '已取消',
    uploadCanceledCount: '已取消 {count} 个文件上传',
    multipartCleanupFailed: '上传失败，未完成分片清理失败',
    uploadPreparing: '准备中...',
    uploadProgress: '上传进度',
    root: '根目录',
    ...
    fileTooLarge: '文件“{name}”超过单文件上传上限 {size}',
    ...
    multipartCleanupTitle: '未完成的分片上传',
    multipartCleanupDesc: '清理 R2 中所有正在进行的多部分上传及其已上传分片。',
    multipartCleanupButton: '清理全部',
    multipartCleanupConfirmTitle: '清理未完成的分片上传',
    multipartCleanupConfirmMsg: '这会取消当前上传，并永久删除桶内所有未完成的多部分上传分片。确定继续吗？',
    multipartCleaning: '正在清理...',
    multipartCleanupEmpty: '没有需要清理的未完成分片上传',
    multipartCleanupSuccess: '已清理 {count} 个未完成的分片上传',
    multipartCleanupPartial: '已清理 {success} 个，{fail} 个清理失败',
  ...
  zh_TW: {
    ...
    uploadHint: '拖放、貼上或點擊即可上傳（單一檔案最大 {size}）',
    ...
    uploading: '正在上傳……',
    uploadingProgress: '{percent}% · {loaded}/{total} · {speed}/秒',
    uploadPausing: '正在暫停 · {percent}% · {loaded}/{total} · {speed}/秒',
    uploadPaused: '已暫停 · {percent}% · {loaded}/{total}',
    pauseUpload: '暫停',
    resumeUpload: '繼續',
    cancelUpload: '取消',
    uploadCanceling: '正在取消並清理……',
    uploadCanceled: '已取消',
    uploadCanceledCount: '已取消 {count} 個檔案上傳',
    multipartCleanupFailed: '上傳失敗，未完成分片清理失敗',
    uploadPreparing: '準備中……',
    uploadProgress: '上傳進度',
    root: '根目錄',
    ...
    fileTooLarge: '檔案「{name}」超過單一檔案上傳上限 {size}',
    ...
    multipartCleanupTitle: '未完成的分片上傳',
    multipartCleanupDesc: '清理 R2 中所有正在進行的多部分上傳及其已上傳分片。',
    multipartCleanupButton: '清理全部',
    multipartCleanupConfirmTitle: '清理未完成的分片上傳',
    multipartCleanupConfirmMsg: '這會取消當前上傳，並永久刪除桶內所有未完成的多部分上傳分片。確定繼續嗎？',
    multipartCleaning: '正在清理……',
    multipartCleanupEmpty: '沒有需要清理的未完成分片上傳',
    multipartCleanupSuccess: '已清理 {count} 個未完成的分片上傳',
    multipartCleanupPartial: '已清理 {success} 個，{fail} 個清理失敗',
  ...
  en: {
    ...
    filenameTplScope: 'Template Applies To',
    ...
    uploadHint: 'Drag, paste, or click to upload (up to {size} per file)',
    ...
    uploading: 'Uploading...',
    uploadingProgress: '{percent}% · {loaded}/{total} · {speed}/s',
    uploadPausing: 'Pausing · {percent}% · {loaded}/{total} · {speed}/s',
    uploadPaused: 'Paused · {percent}% · {loaded}/{total}',
    pauseUpload: 'Pause',
    resumeUpload: 'Resume',
    cancelUpload: 'Cancel',
    uploadCanceling: 'Canceling and cleaning up...',
    uploadCanceled: 'Canceled',
    uploadCanceledCount: 'Canceled {count} upload(s)',
    multipartCleanupFailed: 'Upload failed and its incomplete parts could not be cleaned up',
    ...
    fileTooLarge: '"{name}" exceeds the {size} per-file upload limit',
    ...
    multipartCleanupTitle: 'Incomplete multipart uploads',
    multipartCleanupDesc: 'Remove all in-progress multipart uploads and their uploaded parts from R2.',
    multipartCleanupButton: 'Clean up all',
    multipartCleanupConfirmTitle: 'Clean up incomplete multipart uploads',
    multipartCleanupConfirmMsg:
      'This cancels current uploads and permanently removes every incomplete multipart upload in the bucket. Continue?',
    multipartCleaning: 'Cleaning up...',
    multipartCleanupEmpty: 'No incomplete multipart uploads to clean up',
    multipartCleanupSuccess: 'Cleaned up {count} incomplete multipart upload(s)',
    multipartCleanupPartial: 'Cleaned up {success}; {fail} failed',
  ...
  ja: {
    ...
    uploadHint: 'ドラッグ、貼り付け、クリックでアップロード（1ファイル最大 {size}）',
    dropInvalidHint:
    ...
    uploading: 'アップロード中...',
    uploadingProgress: '{percent}% · {loaded}/{total} · {speed}/秒',
    uploadPausing: '一時停止中 · {percent}% · {loaded}/{total} · {speed}/秒',
    uploadPaused: '一時停止 · {percent}% · {loaded}/{total}',
    pauseUpload: '一時停止',
    resumeUpload: '再開',
    cancelUpload: 'キャンセル',
    uploadCanceling: 'キャンセルしてクリーンアップ中...',
    uploadCanceled: 'キャンセル済み',
    uploadCanceledCount: '{count} 件のアップロードをキャンセルしました',
    multipartCleanupFailed: 'アップロードに失敗し、未完了パーツをクリーンアップできませんでした',
    uploadPreparing: '準備中...',
    ...
    fileTooLarge: '「{name}」は1ファイルのアップロード上限 {size} を超えています',
    ...
    multipartCleanupTitle: '未完了のマルチパートアップロード',
    multipartCleanupDesc: 'R2 の進行中マルチパートアップロードとアップロード済みパーツをすべて削除します。',
    multipartCleanupButton: 'すべてクリーンアップ',
    multipartCleanupConfirmTitle: '未完了アップロードのクリーンアップ',
    multipartCleanupConfirmMsg:
      '現在のアップロードをキャンセルし、バケット内の未完了マルチパートアップロードをすべて完全に削除します。続行しますか？',
    multipartCleaning: 'クリーンアップ中...',
    multipartCleanupEmpty: 'クリーンアップが必要な未完了アップロードはありません',
    multipartCleanupSuccess: '{count} 件の未完了アップロードをクリーンアップしました',
    multipartCleanupPartial: '{success} 件をクリーンアップ、{fail} 件は失敗しました',
